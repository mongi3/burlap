// Slightly modified, but mostly lifted from here:
...
public class Prim {
    ...
    char[][] getMaze(long rngSeed) {
    	Random rng = new Random(rngSeed);
    	// dimensions of generated maze
    	int r=this.height, c=this.width;
        ...
        Point st = new Point((int)(rng.nextDouble()*r),(int)(rng.nextDouble()*c),null);
        maz[st.r][st.c] = 'S';
        ...
        while(!frontier.isEmpty()){
        	...
        	Point cu = frontier.remove((int)(rng.nextDouble()*frontier.size()));
